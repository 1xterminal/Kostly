...
final paymentDetailProvider = FutureProvider.family
    .autoDispose<Map<String, dynamic>, String>((ref, paymentId) async {
      final userId = supabase.auth.currentUser?.id;
      if (userId == null) throw Exception('Not logged in');
      ...
      if (response == null) {
        throw Exception('Payment not found or access denied.');
      }
